...
// type ProjectProps = (typeof projectDatas)[number];
...
//     >
//       <section className="bg-gray-100 max-w-5xl mx-auto border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
...
//           quality={95}
//           className="absolute hidden sm:block top-0 -right-0 w-[32.25rem] rounded-t-lg shadow-2xl
//         transition
